...
Simulates realistic user activity on GourmetGram by continuously sending events to the FastAPI service. This populates the platform with data so the rest of the pipeline (stream consumer, inference service, ETL jobs) has something to work with.
