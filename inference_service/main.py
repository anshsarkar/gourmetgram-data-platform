#!/usr/bin/env python3
"""
Moderation Inference Service - Entry Point
        ...
        with conn.cursor() as cur:
            cur.execute(
                ...
                INSERT INTO moderation_decisions
                    (image_id, inference_mode, moderation_probability,
...
def main():
    ...
    logger.info(f"Model path: s3://{config.model_bucket}/{config.model_prefix}")
    logger.info(f"Model check interval: {config.model_check_interval}s")
    logger.info("=" * 70)
